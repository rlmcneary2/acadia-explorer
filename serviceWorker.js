...
"use strict";
var _regenerator = __webpack_require__(33);var _regenerator2 = _interopRequireDefault(_regenerator);var _asyncToGenerator2 = __webpack_require__(32);var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);var messageHandler = function () {var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(



    function _callee(evt) {var request, error, res, _res, ok, status, statusText, workerResponse;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                        request = evt.data;
                        error = void 0;
                        res = void 0;_context.prev = 3;_context.next = 6;return (

                            fetchResponse(request));case 6:res = _context.sent;_context.next = 12;break;case 9:_context.prev = 9;_context.t0 = _context["catch"](3);


                        error = _context.t0;case 12:_res =

                        res, ok = _res.ok, status = _res.status, statusText = _res.statusText;
                        if (!ok || error) {
                            if (res.error) {
                                res = res.error();
                            }
                        ...
                        ok && !error)) {_context.next = 27;break;}if (!
                        request.responseFunction) {_context.next = 22;break;}_context.next = 19;return (
                            res[request.responseFunction]());case 19:workerResponse.response = _context.sent;_context.next = 25;break;case 22:_context.next = 24;return (


                            res.json());case 24:workerResponse.response = _context.sent;case 25:_context.next = 34;break;case 27:if (



                        error) {_context.next = 33;break;}_context.next = 30;return (
                            res.text());case 30:workerResponse.error = _context.sent;_context.next = 34;break;case 33:


                        workerResponse.error = error;case 34:


                        worker.postMessage(workerResponse);case 35:case "end":return _context.stop();}}}, _callee, this, [[3, 9]]);}));return function messageHandler(_x) {return _ref.apply(this, arguments);};}();var fetchResponse = function () {var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(

    function _callee2(request) {var method, url, options, req;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                        ...
                        req = new Request(url, options);_context2.next = 7;return (
                            fetch(req));case 7:return _context2.abrupt("return", _context2.sent);case 8:case "end":return _context2.stop();}}}, _callee2, this);}));return function fetchResponse(_x2) {return _ref2.apply(this, arguments);};}();function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var worker = self; // "as" gymanstics to prevent tslint errors.
worker.addEventListener("message", function (evt) {messageHandler(evt);});
